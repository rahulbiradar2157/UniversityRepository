  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="logindex.php"><span class="glyphicon glyphicon-home"></span> Home</a></li>
       <li><a href="display.php"><span class="glyphicon glyphicon-download">Archive</a></li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      ...
      <div class="item active">
        <img src="images/clg5.jpg" alt="Chania" width="640" height="480">
        <div class="carousel-caption">
          </div>
      </div>

      <div class="item">
        <img src="images/clg4.jpg" alt="Chania" width="640" height="480">
        <div class="carousel-caption">
         </div>
      </div>
    
      <div class="item">
        <img src="images/clg6.jpg" alt="Flower" width="640" height="480">
        <div class="carousel-caption">
        </div>
      </div>
...
<!--div class="corners">
<h5>Welcome to Dr. Babasaheb Ambedkar Technological University's Institutional Repository</h5>
<h6>This service, being maintained by the University Library, increases the visibility of DBATU's research and the materials within it are centrally stored and preserved.Please expect some delay in the processing of papers.Newly submitted papers will be updated in a day or two.</h6>
<h5>Thank you.</h5>
</div!-->
...
<div id="departments">
        <h3>Departments in the Institutional Repository</h3>
        <p id="">Choose a department to browse its collections.</p>
